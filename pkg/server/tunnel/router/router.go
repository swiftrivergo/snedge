...
func (r *Router) getTransport(id, host string) (string, *http.Transport) {
	...
	if ok {
		...
		return val.scheme, val.transport
	}
	r.transportLock.RUnlock()
	...
	t := &http.Transport{
		...
		DialContext: func(ctx context.Context, network, address string) (net.Conn, error) {
			...
			return r.Server.Dialer(id, timeout) (network, targetHost)
		},
	...
	r.transports[transportKey{id: id, host: host}] = transportValue{scheme: scheme, transport: t}
	return scheme, t
}
...
func (r *Router) Add(req *http.Request) string {
	...
	id := req.Header.Get(transport.InHeader)
